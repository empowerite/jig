...
[rfc-001-types.md](rfc-001-types.md) and the view of the model in [rfc-001-types.md](rfc-001-types.md),
...
and executes what it returns through the ports of [rfc-003-ports.md](rfc-003-ports.md).
